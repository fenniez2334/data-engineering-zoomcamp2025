...
def create_events_aggregated_sink(t_env):
    table_name = 'green_tripdata_session1'
    sink_ddl = f"""
...
def log_aggregation():
    ...
    env.enable_checkpointing(30 * 1000) # 10 seconds interval
    ...
    try:
        ...
        INSERT INTO {aggregated_table}
            SELECT
                PULocationID,
                DOLocationID,
                MIN(lpep_dropoff_datetime) AS session_start,
                MAX(lpep_dropoff_datetime) AS session_end,
                count(1) AS num_hits
            FROM {source_table}
            GROUP BY 
                PULocationID, 
